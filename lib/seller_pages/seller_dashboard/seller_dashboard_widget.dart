  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<StoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<StoresRecord> sellerDashboardStoresRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final sellerDashboardStoresRecord =
            sellerDashboardStoresRecordList.isNotEmpty
                ? sellerDashboardStoresRecordList.first
                : null;
                        ...
                        queryBuilder: (storeInventoryRecord) =>
                            storeInventoryRecord
                                .where(
                                  'store_ref',
                                  isEqualTo:
                                      sellerDashboardStoresRecord?.reference,
                                )
