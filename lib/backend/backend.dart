...
/// Functions to query StoreInventoryRecords (as a Stream and as a Future).
Future<int> queryStoreInventoryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<StoreInventoryRecord>> queryStoreInventoryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<StoreInventoryRecord>> queryStoreInventoryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
