...
class BuyerHomeWidget extends StatefulWidget {
  ...
  static String routeName = 'buyer_home';
  static String routePath = '/buyerHome';
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 10.0, 0.0, 0.0),
                                          child: Text(
                                            'Find affordable goverment medicines near you ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 50.0, 16.0, 0.0),
                                      child: Text(
                                        'Take a clear photo or upload a photo of your prescription for quick medicine search',
